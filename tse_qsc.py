...
y = df_rel['y']
X_tsne = tsne(X, dimensions=2, perplexity=params['perplexity'], theta=0.5, rand_seed=42)
...
plt.tight_layout()
plt.savefig(os.path.join(results_path,f'tse_nfp{nfp}_perplexity{params["perplexity"]}.png'), dpi=200)
